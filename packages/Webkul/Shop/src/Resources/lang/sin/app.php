...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Folmix :current_year, ඉන්දියාවේ ලියාපදිංචි. සියලු අයිතියන්ගේ අනුමානය වෙනස් වේ.',
        ...
        'login-form' => [
            ...
            'password' => 'මුරපදය',
            'please-login-first' => 'ඉදිරියට යාමට කරුණාකර පිවිසෙන්න.',
        ...
        'signup-form' => [
            ...
            'address' => 'ලිපිනය',
            'bagisto' => 'Folmix',
            'button-title' => 'ලියාපදිංචිය',
            'city' => 'නගරය/පළාත/කලාපය',
            'click-here' => 'මෙතන ක්ලික් කරන්න',
            'confirm-pass' => 'මුරපදය තහවුර',
            'country' => 'රට',
            'email' => 'පරිශීලක විද්‍යුත් තැපෑල',
            'first-name' => 'මුල් නම',
            'footer' => '© Folmix :current_year, ඉන්දියාවේ ලියාපදිංචි. සියලු අයිතියන්ගේ අනුමානය වෙනස් වේ.',
            ...
            'vat-number-hint' => 'කරුණාකර නිවැරදි වැට් අංකය ඇතුළත් කරන්න',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'පැතිකඩ',
                        'search' => 'සෙවීම',
                        'search-no-results' => 'නිෂ්පාදන හමු නොවීය.',
                        'search-text' => 'මෙහි නිෂ්පාදන සොයන්න',
                        'search-view-all-prefix' => 'සියලුම ප්‍රතිඵල බලන්න',
                        'sign-in' => 'පිවිසෙන්න',
            ...
            'search-suggestions' => [
                'no-results' => 'නිෂ්පාදන හමු නොවීය.',
                'searching' => 'සොයමින්...',
                'view-all-results-for' => 'සියලුම ප්‍රතිඵල බලන්න',
            ],
            ...
            'whatsapp' => [
                'chat-with-us' => 'WhatsApp හරහා අප සමඟ කතාබස් කරන්න',
            ],

            'footer' => [
                'about-tagline' => 'Folmix වෙත සාදරයෙන් පිළිගනිමු. විශ්වාසදායක ගුණාත්මකභාවයක් හා සේවාවක් සමඟ අපගේ අමතර කොටස් සහ උපාංග පරාසය ගවේෂණය කරන්න.',
                'about-us' => 'අප ගැන',
                'contact-us' => 'අප හා සම්බන්ධයෙන්',
                'currency' => 'මුදල්',
                'customer-service' => 'ප්‍රශ්නය හා සේවය',
                'footer-content' => 'පිටුවේ අන්තර්ගතය',
                'footer-text' => '© Folmix :current_year. සියලු අභිරුචිකරුවන් සමඟ සම්පූර්ණයෙන් පහසුවෙනි.',
                'locale' => 'පිටු මාධ්‍ය',
                'need-help' => 'උදව් අවශ්‍යද? අපට කතා කරන්න!',
                ...
                'useful-links' => 'ප්‍රයෝජනවත් සබැඳි',
                'whats-new' => 'මොතා කුමුද?',
                'address-heading' => 'Address',
                'address-trademark' => 'FOLMIX it\'s a Trademark belong to Electroclean',
                'address-street' => 'Via Principe Amedeo, 131',
                'address-city' => '70121 Bari - Italy',
                'address-vat' => 'Vat / P.Iva: IT05296370728',
            ],
