...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright :current_year, Folmix. Tutti i diritti riservati.',
        ...
        'signup-form' => [
            ...
            'vat-number-hint' => 'Inserisci il numero di partita IVA corretto',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'Profilo',
                        'search' => 'Cerca',
                        'search-no-results' => 'Nessun prodotto trovato.',
                        'search-text' => 'Cerca prodotti qui',
                        'search-view-all-prefix' => 'Vedi tutti i risultati per',
                        'sign-in' => 'Accedi',
                        'sign-up' => 'Registrati',
                        'submit' => 'Invia',
                        'welcome' => 'Benvenuto',
            ...
            'search-suggestions' => [
                'no-results' => 'Nessun prodotto trovato.',
                'searching' => 'Ricerca in corso...',
                'view-all-results-for' => 'Vedi tutti i risultati per',
            ],
            ...
            'whatsapp' => [
                'chat-with-us' => 'Chatta con noi su WhatsApp',
            ],

            'footer' => [
                'about-tagline' => 'Benvenuto su Folmix. Scopri la nostra ampia gamma di ricambi e accessori con la qualità e il servizio di cui puoi fidarti.',
                'about-us' => 'Chi siamo',
                'contact-us' => 'Contattaci',
                'currency' => 'Valuta',
                'customer-service' => 'Servizio clienti',
                'footer-content' => 'Contenuto del piè di pagina',
                'footer-text' => '© Copyright :current_year, Folmix. Tutti i diritti riservati.',
                'locale' => 'Lingua',
                'need-help' => 'Hai bisogno di aiuto? Chiamaci!',
