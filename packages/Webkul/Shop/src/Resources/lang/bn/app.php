...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© কপিরাইট :current_year, ওয়েবকুল সফটওয়্যার (ভারতে নিবন্ধিত)। সব অধিকার সংরক্ষিত।',
        ...
        'signup-form' => [
            ...
            'address' => 'ঠিকানা',
            'bagisto' => 'Folmix',
            'button-title' => 'নিবন্ধন',
            'city' => 'শহর/প্রদেশ/অঞ্চল',
            ...
            'vat-number-hint' => 'সঠিক ভ্যাট নম্বর লিখুন',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'প্রোফাইল',
                        'search' => 'অনুসন্ধান',
                        'search-no-results' => 'কোনো পণ্য পাওয়া যায়নি।',
                        'search-text' => 'এখানে পণ্য অনুসন্ধান করুন',
                        'search-view-all-prefix' => 'সব ফলাফল দেখুন',
                        'sign-in' => 'সাইন ইন',
                        'sign-up' => 'সাইন আপ',
                        'submit' => 'জমা দিন',
                        'welcome' => 'স্বাগতম',
            ...
            'whatsapp' => [
                'chat-with-us' => 'হোয়াটসঅ্যাপে আমাদের সাথে চ্যাট করুন',
            ],

            'footer' => [
                'about-tagline' => 'Folmix-এ স্বাগতম। বিশ্বস্ত মান ও সেবার সাথে আমাদের বিস্তৃত স্পেয়ার পার্টস ও এক্সেসরিজ সংগ্রহ দেখুন।',
                'about-us' => 'আমাদের সম্পর্কে',
                'contact-us' => 'যোগাযোগ করুন',
                'currency' => 'মুদ্রা',
                'customer-service' => 'গ্রাহক সেবা',
                'footer-content' => 'ফুটারের সামগ্রী',
                'footer-text' => '© কপিরাইট :current_year, Folmix। সমস্ত অধিকার সংরক্ষিত।',
                'locale' => 'লোকেল',
                'need-help' => 'সাহায্য দরকার? আমাদের কল করুন!',
