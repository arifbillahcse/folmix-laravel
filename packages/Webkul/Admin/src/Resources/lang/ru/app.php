...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Пол',
                    'group' => 'Группа',
                    'group-not-found' => 'Выбранная группа клиентов не найдена.',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    ...
                    'info' => 'Установите индивидуальную цену для этого клиента на определённые товары, заменяющую цену его группы.',
                    ...
                    'edit-btn' => 'Изменить',
                    'delete-btn' => 'Удалить',
                    'empty-title' => 'Нет специальных цен',
                    'empty-info' => 'У этого клиента ещё нет индивидуальной цены ни на один товар.',
                    'create-success' => 'Специальная цена успешно добавлена.',
                    'update-success' => 'Специальная цена успешно обновлена.',
                    'delete-success' => 'Специальная цена успешно удалена.',
                ],
    ...
    'settings' => [
        ...
        'login-sliders' => [
            'index' => [
                'create-btn' => 'Создать слайдер',
                'title' => 'Слайдеры страницы входа',
                ...
                'create-success' => 'Слайдер успешно создан.',
                'delete-failed' => 'Не удалось удалить слайдер',
                'delete-success' => 'Слайдер успешно удален.',
                'delete-warning' => 'Вы уверены, что хотите выполнить это действие?',
                'update-success' => 'Слайдер успешно обновлен.',
            ],
        ],
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Каналы',
                'column' => 'Колонка',
                'copy-to-all-locales-btn' => 'Копировать на все языки',
                'copy-to-all-locales-confirm' => 'Это приведет к перезаписи сохраненного содержимого на всех остальных языках содержимым, сохраненным в настоящее время для этого языка. Продолжить?',
                'copy-to-all-locales-error' => 'Что-то пошло не так при копировании на все языки.',
                'copy-to-all-locales-success' => 'Успешно скопировано на все языки.',
                ...
                'filters' => 'Фильтры',
                'flash-sale' => 'Флеш-распродажа',
                'flash-sale-description' => 'Выберите товары для раздела флеш-распродажи и перетащите их, чтобы задать порядок.',
                'flash-sale-subtitle' => 'Подзаголовок',
                ...
                'promo-banner-add-card-btn' => 'Добавить карточку',
                'promo-banner-button-text' => 'Текст кнопки',
                'promo-banner-card-image' => 'Изображение карточки',
                'promo-banner-card-title' => 'Заголовок карточки',
                'promo-banner-cards' => 'Промо-карточки',
                'promo-banner-cards-description' => 'Добавляйте, редактируйте, меняйте порядок или удаляйте промо-карточки, отображаемые под заголовком.',
        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'footer' => [
                        ...
                        'info' => 'Настройте слоган, номер телефона и адрес, отображаемые в подвале магазина.',
                        'tagline' => 'Слоган',
                        'need-help-text' => 'Текст "Нужна помощь"',
                        'phone-number' => 'Номер телефона',
                        'address-heading' => 'Заголовок адреса',
                        'address-trademark' => 'Строка товарного знака',
                        'address-street' => 'Улица',
                        'address-city' => 'Город / Почтовый индекс / Страна',
                        'address-vat' => 'ИНН / Регистрационный номер',
                    ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'private-website' => [
                        'title' => 'Приватный сайт',
                        'title-info' => 'Если включено, каждая страница магазина требует, чтобы посетитель был авторизован как утверждённый клиент. Только вход, регистрация и восстановление пароля остаются доступны гостям.',
                        'enabled' => 'Требовать вход для просмотра магазина',
                        'enabled-info' => 'Включите это, когда магазин готов к запуску, и посетители больше не должны иметь возможность просматривать его без регистрации и одобрения.',
                    ],
                ],
            ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'При поддержке :softorio.',
            ],
        ],
