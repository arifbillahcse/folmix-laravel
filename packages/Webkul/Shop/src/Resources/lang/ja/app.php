...
return [
    'customers' => [
        ...
        'login-form' => [
            ...
            'page-title' => '顧客ログイン',
            'password' => 'パスワード',
            'please-login-first' => '続けるにはログインしてください。',
        ...
        'signup-form' => [
            ...
            'username' => 'ユーザー名',
            'vat-number' => 'VAT番号',
            'vat-number-hint' => '正しいVAT番号を入力してください',
            ...
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'プロフィール',
                        'search' => '検索',
                        'search-no-results' => '商品が見つかりませんでした。',
                        'search-text' => 'ここで商品を検索',
                        'search-view-all-prefix' => 'すべての結果を表示',
                        'sign-in' => 'サインイン',
                        'sign-up' => 'サインアップ',
                        'submit' => '送信',
                        'welcome' => 'ようこそ',
