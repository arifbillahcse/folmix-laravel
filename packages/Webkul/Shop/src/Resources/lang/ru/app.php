...
return [
    'customers' => [
        ...
        'login-form' => [
            ...
            'password' => 'Пароль',
            'please-login-first' => 'Пожалуйста, войдите, чтобы продолжить.',
        ...
        'signup-form' => [
            ...
            'vat-number-hint' => 'Пожалуйста, введите правильный номер НДС',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'Профиль',
                        'search' => 'Поиск',
                        'search-no-results' => 'Товары не найдены.',
                        'search-text' => 'Искать товары здесь',
                        'search-view-all-prefix' => 'Смотреть все результаты для',
                        'sign-in' => 'Войти',
            ...
            'search-suggestions' => [
                'no-results' => 'Товары не найдены.',
                'searching' => 'Поиск...',
                'view-all-results-for' => 'Показать все результаты по запросу',
            ],
            ...
            'whatsapp' => [
                'chat-with-us' => 'Написать нам в WhatsApp',
            ],

            'footer' => [
                'about-tagline' => 'Добро пожаловать в Folmix. Ознакомьтесь с широким ассортиментом запчастей и аксессуаров с качеством и сервисом, которым можно доверять.',
                'about-us' => 'О нас',
                ...
                'locale' => 'Язык',
                'need-help' => 'Нужна помощь? Позвоните нам!',
