...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright :current_year, Folmix. Todos os direitos reservados.',
        ...
        'signup-form' => [
            ...
            'vat-number-hint' => 'Insira o número de IVA correto',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'Perfil',
                        'search' => 'Pesquisar',
                        'search-no-results' => 'Nenhum produto encontrado.',
                        'search-text' => 'Pesquisar produtos aqui',
                        'search-view-all-prefix' => 'Ver todos os resultados de',
                        'sign-in' => 'Entrar',
            ...
            'search-suggestions' => [
                ...
                'view-all-results-for' => 'Ver todos os resultados de',
            ],
            ...
            'whatsapp' => [
                'chat-with-us' => 'Converse conosco pelo WhatsApp',
            ],

            'footer' => [
                'about-tagline' => 'Bem-vindo à Folmix. Explore nossa ampla gama de peças de reposição e acessórios com a qualidade e o atendimento em que você pode confiar.',
                'about-us' => 'Sobre Nós',
                'contact-us' => 'Fale Conosco',
                'currency' => 'Moeda',
                'customer-service' => 'Atendimento ao Cliente',
                'footer-content' => 'Conteúdo do Rodapé',
                'footer-text' => '© Direitos autorais :current_year, Folmix. Todos os direitos reservados.',
                'locale' => 'Localização',
                'need-help' => 'Precisa de ajuda? Ligue para nós!',
