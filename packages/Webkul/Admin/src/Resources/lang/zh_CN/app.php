    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => '频道',
                'column' => '列',
                'copy-to-all-locales-btn' => '复制到所有语言',
                'copy-to-all-locales-confirm' => '这将用当前语言已保存的内容覆盖所有其他语言中已保存的内容。是否继续？',
                'copy-to-all-locales-error' => '复制到所有语言时出现问题。',
                'copy-to-all-locales-success' => '已成功复制到所有语言。',
                'create-filter' => '创建过滤器',
                'css' => 'CSS',
                'delete' => '删除',
                'desc' => '降序',
                ...
                'promo-banner-add-card-btn' => '添加卡片',
                'promo-banner-button-text' => '按钮文本',
                'promo-banner-card-image' => '卡片图片',
                'promo-banner-card-title' => '卡片标题',
                'promo-banner-cards' => '促销卡片',
                'promo-banner-cards-description' => '添加、编辑、重新排序或删除标题下方显示的促销卡片。',
                'promo-banner-heading' => '标题',
                'promo-banner-heading-block' => '标题',
                'promo-banner-text' => '文本',
                'save-btn' => '保存',
                'select' => '选择',
                'slider' => '滑块',
                'slider-add-btn' => '添加滑块',
        ...
        'index' => [
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'private-website' => [
                        'title' => '私密网站',
                        'title-info' => '启用后，商店的每个页面都要求访问者以已批准的客户身份登录。仅登录、注册和密码找回页面仍可供访客访问。',
                        'enabled' => '浏览商店需要登录',
                        'enabled-info' => '当商店准备好上线且访问者不应再在未注册和未获批准的情况下浏览时，启用此选项。',
                    ],
                ],
            ],
