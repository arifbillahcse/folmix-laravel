...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'group' => 'Grup',
                    'group-not-found' => 'Grup pelanggan yang dipilih tidak ditemukan.',
                    'id' => 'ID Pelanggan',
                    'id-value' => 'ID - :id',
                    'inactive' => 'Tidak Aktif',
                    'method-error' => 'Kesalahan! Metode yang salah terdeteksi, silakan periksa konfigurasi aksi massal',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Channel',
                'column' => 'Kolom',
                'copy-to-all-locales-btn' => 'Salin Ke Semua Bahasa',
                'copy-to-all-locales-confirm' => 'Ini akan menimpa konten tersimpan di setiap bahasa lain dengan konten yang saat ini tersimpan untuk bahasa ini. Lanjutkan?',
                'copy-to-all-locales-error' => 'Terjadi kesalahan saat menyalin ke semua bahasa.',
                'copy-to-all-locales-success' => 'Berhasil disalin ke semua bahasa.',
                ...
                'promo-banner-add-card-btn' => 'Tambah Kartu',
                'promo-banner-button-text' => 'Teks Tombol',
                'promo-banner-card-image' => 'Gambar Kartu',
                'promo-banner-card-title' => 'Judul Kartu',
                'promo-banner-cards' => 'Kartu Promo',
                'promo-banner-cards-description' => 'Tambah, edit, atur ulang, atau hapus kartu promo yang ditampilkan di bawah judul.',
                'promo-banner-heading' => 'Judul',
                'promo-banner-heading-block' => 'Judul',
                'promo-banner-text' => 'Teks',
                'save-btn' => 'Simpan',
                'select' => 'Pilih',
                'slider' => 'Slider',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Didukung oleh :softorio.',
            ],
        ],
