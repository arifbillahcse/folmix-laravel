...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© זכויות יוצרים :current_year, Folmix. כל הזכויות שמורות.',
        ...
        'login-form' => [
            ...
            'password' => 'סיסמה',
            'please-login-first' => 'אנא התחבר כדי להמשיך.',
        ...
        'signup-form' => [
            ...
            'vat-number-hint' => 'אנא הזן את מספר המע"מ הנכון',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'פרופיל',
                        'search' => 'חיפוש',
                        'search-no-results' => 'לא נמצאו מוצרים.',
                        'search-text' => 'חפש מוצרים כאן',
                        'search-view-all-prefix' => 'הצג את כל התוצאות עבור',
                        'sign-in' => 'התחברות',
                        'sign-up' => 'הרשמה',
                        'submit' => 'שלח',
                        'welcome' => 'ברוך הבא',
            ...
            'whatsapp' => [
                'chat-with-us' => 'שוחח איתנו בוואטסאפ',
            ],

            'footer' => [
                'about-tagline' => 'ברוכים הבאים ל-Folmix. גלו את מגוון חלקי החילוף והאביזרים שלנו באיכות ובשירות שאפשר לסמוך עליהם.',
                'about-us' => 'אודותנו',
                'contact-us' => 'צור קשר',
                'currency' => 'מטבע',
                'customer-service' => 'שירות לקוחות',
                'footer-content' => 'תוכן תחתית הדף',
                'footer-text' => '© זכויות יוצרים :current_year, Folmix. כל הזכויות שמורות.',
                'locale' => 'אזור',
                'need-help' => 'צריכים עזרה? התקשרו אלינו!',
