...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© 版权所有 :current_year，Folmix。保留所有权利。',
        ...
        'reset-password' => [
            ...
            'email' => '注册电子邮件',
            'footer' => '© 版权 :current_year，Folmix。保留所有权利。',
            'password' => '密码',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => '个人资料',
                        'search' => '搜索',
                        'search-no-results' => '未找到商品。',
                        'search-text' => '在这里搜索商品',
                        'search-view-all-prefix' => '查看全部结果',
                        'sign-in' => '登录',
                        'sign-up' => '注册',
                        'submit' => '提交',
                        'welcome' => '欢迎',
            ...
            'footer' => [
                ...
                'footer-content' => '页脚内容',
                'footer-text' => '© 版权所有 :current_year，Folmix。保留所有权利。',
                'locale' => '语言',
                'need-help' => '需要帮助？请致电我们！',
                'order-return' => '订单和退货',
                'payment-policy' => '付款政策',
