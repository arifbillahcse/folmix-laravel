...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Geschlecht',
                    'group' => 'Gruppe',
                    'group-not-found' => 'Die ausgewählte Kundengruppe konnte nicht gefunden werden.',
                    'id' => 'Kunden-ID',
                    'id-value' => 'ID - :id',
                    'inactive' => 'Inaktiv',
                    'method-error' => 'Fehler! Falsche Methode erkannt, bitte überprüfen Sie die Massenaktionskonfiguration',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Kanäle',
                'column' => 'Spalte',
                'copy-to-all-locales-btn' => 'In alle Sprachen kopieren',
                'copy-to-all-locales-confirm' => 'Dadurch wird der gespeicherte Inhalt in allen anderen Sprachen mit dem aktuell für diese Sprache gespeicherten Inhalt überschrieben. Fortfahren?',
                'copy-to-all-locales-error' => 'Beim Kopieren in alle Sprachen ist ein Fehler aufgetreten.',
                'copy-to-all-locales-success' => 'Erfolgreich in alle Sprachen kopiert.',
                ...
                'promo-banner-add-card-btn' => 'Karte hinzufügen',
                'promo-banner-button-text' => 'Button-Text',
                'promo-banner-card-image' => 'Kartenbild',
                'promo-banner-card-title' => 'Kartentitel',
                'promo-banner-cards' => 'Werbekarten',
                'promo-banner-cards-description' => 'Fügen Sie die unter der Überschrift angezeigten Werbekarten hinzu, bearbeiten, sortieren oder entfernen Sie sie.',
                'promo-banner-heading' => 'Überschrift',
                'promo-banner-heading-block' => 'Überschrift',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Bereitgestellt von :softorio.',
            ],
        ],
