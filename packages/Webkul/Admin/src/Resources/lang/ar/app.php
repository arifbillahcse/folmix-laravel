        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'الجنس',
                    'group' => 'المجموعة',
                    'group-not-found' => 'لم يتم العثور على مجموعة العملاء المحددة.',
                    'id' => 'رقم العميل',
                    'id-value' => 'المعرف - :id',
                    'inactive' => 'غير نشط',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    'title' => 'التسعير الخاص',
                    'info' => 'حدد سعرًا مخصصًا لهذا العميل على منتجات معينة، يتجاوز سعر مجموعته.',
                    ...
                    'edit-btn' => 'تعديل',
                    'delete-btn' => 'حذف',
                    'empty-title' => 'لا يوجد تسعير خاص',
                    'empty-info' => 'لا يملك هذا العميل سعرًا مخصصًا لأي منتج بعد.',
                    'create-success' => 'تمت إضافة السعر الخاص بنجاح.',
                    'update-success' => 'تم تحديث السعر الخاص بنجاح.',
                    'delete-success' => 'تمت إزالة السعر الخاص بنجاح.',
                ],
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'القنوات',
                'column' => 'عمود',
                'copy-to-all-locales-btn' => 'نسخ إلى جميع اللغات',
                'copy-to-all-locales-confirm' => 'سيؤدي هذا إلى استبدال المحتوى المحفوظ في جميع اللغات الأخرى بالمحتوى المحفوظ حاليًا لهذه اللغة. هل تريد المتابعة؟',
                'copy-to-all-locales-error' => 'حدث خطأ ما أثناء النسخ إلى جميع اللغات.',
                'copy-to-all-locales-success' => 'تم النسخ إلى جميع اللغات بنجاح.',
                ...
                'promo-banner-add-card-btn' => 'إضافة بطاقة',
                'promo-banner-button-text' => 'نص الزر',
                'promo-banner-card-image' => 'صورة البطاقة',
                'promo-banner-card-title' => 'عنوان البطاقة',
                'promo-banner-cards' => 'بطاقات ترويجية',
                'promo-banner-cards-description' => 'أضف أو عدّل أو أعد ترتيب أو احذف البطاقات الترويجية الظاهرة أسفل العنوان.',
                'promo-banner-heading' => 'العنوان',
                'promo-banner-heading-block' => 'العنوان',
                'promo-banner-text' => 'النص',
                'save-btn' => 'حفظ',
                'select' => 'اختيار',
                'slider' => 'شريط',
        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'footer' => [
                        'title' => 'محتوى التذييل',
                        'info' => 'قم بتكوين الشعار ورقم الهاتف والعنوان المعروضة في تذييل واجهة المتجر.',
                        'tagline' => 'الشعار',
                        'need-help-text' => 'نص طلب المساعدة',
                        'phone-number' => 'رقم الهاتف',
                        'address-heading' => 'عنوان القسم',
                        'address-trademark' => 'سطر العلامة التجارية',
                        'address-street' => 'عنوان الشارع',
                        'address-city' => 'المدينة / الرمز البريدي / الدولة',
                        'address-vat' => 'رقم ضريبة القيمة المضافة / رقم التسجيل',
                    ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'private-website' => [
                        'title' => 'الموقع الخاص',
                        'title-info' => 'عند التفعيل، يتطلب كل صفحة في المتجر أن يكون الزائر مسجلاً الدخول كعميل معتمد. تبقى صفحات تسجيل الدخول والتسجيل واستعادة كلمة المرور فقط متاحة للزوار.',
                        'enabled' => 'طلب تسجيل الدخول لتصفح المتجر',
                        'enabled-info' => 'قم بتفعيل هذا الخيار عندما يكون المتجر جاهزًا للانطلاق ولم يعد بإمكان الزوار التصفح دون التسجيل والموافقة عليهم.',
                    ],
                ],
            ],
