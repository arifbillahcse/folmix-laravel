        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => '性別',
                    'group' => 'グループ',
                    'group-not-found' => '選択した顧客グループが見つかりませんでした。',
                    'id' => '顧客ID',
                    'id-value' => 'ID - :id',
                    'inactive' => '非アクティブ',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'チャンネル',
                'column' => 'カラム',
                'copy-to-all-locales-btn' => 'すべての言語にコピー',
                'copy-to-all-locales-confirm' => 'これにより、他のすべての言語に保存されている内容が、この言語で現在保存されている内容で上書きされます。続行しますか?',
                'copy-to-all-locales-error' => 'すべての言語へのコピー中に問題が発生しました。',
                'copy-to-all-locales-success' => 'すべての言語へのコピーに成功しました。',
                ...
                'promo-banner-add-card-btn' => 'カードを追加',
                'promo-banner-button-text' => 'ボタンテキスト',
                'promo-banner-card-image' => 'カード画像',
                'promo-banner-card-title' => 'カードタイトル',
                'promo-banner-cards' => 'プロモカード',
                'promo-banner-cards-description' => '見出しの下に表示されるプロモカードの追加、編集、並べ替え、削除を行います。',
                'promo-banner-heading' => '見出し',
                'promo-banner-heading-block' => '見出し',
                'promo-banner-text' => 'テキスト',
                'save-btn' => '保存',
                'select' => '選択',
                'slider' => 'スライダー',
        ...
        'index' => [
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'private-website' => [
                        'title' => 'プライベートウェブサイト',
                        'title-info' => '有効にすると、ストアフロントのすべてのページで、訪問者が承認済みの顧客としてログインしている必要があります。ログイン、登録、パスワード再設定のみがゲストに公開されたままになります。',
                        'enabled' => 'ストア閲覧にログインを必須にする',
                        'enabled-info' => 'ストアが公開準備できたらこれを有効にしてください。訪問者は登録して承認されない限り閲覧できなくなります。',
                    ],
                ],
            ],
