...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Gênero',
                    'group' => 'Grupo',
                    'group-not-found' => 'O grupo de clientes selecionado não foi encontrado.',
                    'id' => 'ID do Cliente',
                    'id-value' => 'ID - :id',
                    'inactive' => 'Inativo',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    ...
                    'info' => 'Defina um preço personalizado para este cliente em produtos específicos, substituindo o preço do grupo dele.',
                    'add-btn' => 'Adicionar preço de produto',
                    'sku' => 'SKU - :sku',
                    'price' => 'Preço',
                    'regular-price' => 'Preço normal - :price',
                    'create-title' => 'Adicionar preço especial',
                    'update-title' => 'Atualizar preço especial',
                    'save-btn' => 'Salvar',
                    'edit-btn' => 'Editar',
                    'delete-btn' => 'Excluir',
                    'empty-title' => 'Sem preços especiais',
                    'empty-info' => 'Este cliente ainda não possui preço personalizado em nenhum produto.',
                    'create-success' => 'Preço especial adicionado com sucesso.',
                    'update-success' => 'Preço especial atualizado com sucesso.',
                    'delete-success' => 'Preço especial removido com sucesso.',
                ],
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Canais',
                'column' => 'Coluna',
                'copy-to-all-locales-btn' => 'Copiar Para Todos os Idiomas',
                'copy-to-all-locales-confirm' => 'Isso substituirá o conteúdo salvo em todos os outros idiomas pelo conteúdo salvo atualmente para este idioma. Continuar?',
                'copy-to-all-locales-error' => 'Algo deu errado ao copiar para todos os idiomas.',
                'copy-to-all-locales-success' => 'Copiado para todos os idiomas com sucesso.',
                ...
                'promo-banner-add-card-btn' => 'Adicionar Cartão',
                'promo-banner-button-text' => 'Texto do Botão',
                'promo-banner-card-image' => 'Imagem do Cartão',
                'promo-banner-card-title' => 'Título do Cartão',
                'promo-banner-cards' => 'Cartões Promocionais',
                'promo-banner-cards-description' => 'Adicione, edite, reordene ou remova os cartões promocionais exibidos abaixo do título.',
                'promo-banner-heading' => 'Título',
                'promo-banner-heading-block' => 'Título',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Desenvolvido por :softorio.',
            ],
        ],
