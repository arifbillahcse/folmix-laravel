...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Стать',
                    'group' => 'Група',
                    'group-not-found' => 'Обрану групу клієнтів не знайдено.',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    ...
                    'info' => 'Встановіть індивідуальну ціну для цього клієнта на певні товари, яка замінить ціну його групи.',
                    'add-btn' => 'Додати ціну товару',
                    'sku' => 'SKU - :sku',
                    'price' => 'Ціна',
                    'regular-price' => 'Звичайна ціна - :price',
                    'create-title' => 'Додати спеціальну ціну',
                    'update-title' => 'Оновити спеціальну ціну',
                    'save-btn' => 'Зберегти',
                    'edit-btn' => 'Редагувати',
                    'delete-btn' => 'Видалити',
                    'empty-title' => 'Немає спеціальних цін',
                    'empty-info' => 'У цього клієнта ще немає індивідуальної ціни на жоден товар.',
                    'create-success' => 'Спеціальну ціну успішно додано.',
                    'update-success' => 'Спеціальну ціну успішно оновлено.',
                    'delete-success' => 'Спеціальну ціну успішно видалено.',
                ],
    ...
    'settings' => [
        ...
        'login-sliders' => [
            'index' => [
                'create-btn' => 'Створити слайдер',
                'title' => 'Слайдери сторінки входу',
                ...
                'create' => [
                    ...
                    'link' => 'Посилання',
                    'save-btn' => 'Зберегти слайдер',
                    'sort-order' => 'Порядок сортування',
                    'status' => 'Статус',
                    'title' => 'Створити слайдер',
                ...
                'create-success' => 'Слайдер успішно створено.',
                'delete-failed' => 'Не вдалося видалити слайдер',
                'delete-success' => 'Слайдер успішно видалено.',
                'delete-warning' => 'Ви впевнені, що хочете виконати цю дію?',
                'update-success' => 'Слайдер успішно оновлено.',
            ],
        ],
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Канали',
                'column' => 'Колонка',
                'copy-to-all-locales-btn' => 'Копіювати на всі мови',
                'copy-to-all-locales-confirm' => 'Це призведе до перезапису збереженого вмісту в усіх інших мовах вмістом, який зараз збережено для цієї мови. Продовжити?',
                'copy-to-all-locales-error' => 'Під час копіювання на всі мови сталася помилка.',
                'copy-to-all-locales-success' => 'Успішно скопійовано на всі мови.',
                ...
                'filters' => 'Фільтри',
                'flash-sale' => 'Флеш-розпродаж',
                'flash-sale-description' => 'Виберіть товари для розділу флеш-розпродажу та перетягніть, щоб задати порядок.',
                'flash-sale-subtitle' => 'Підзаголовок',
                ...
                'promo-banner-add-card-btn' => 'Додати картку',
                'promo-banner-button-text' => 'Текст кнопки',
                'promo-banner-card-image' => 'Зображення картки',
                'promo-banner-card-title' => 'Заголовок картки',
                'promo-banner-cards' => 'Промо-картки',
                'promo-banner-cards-description' => 'Додавайте, редагуйте, змінюйте порядок або видаляйте промо-картки, що відображаються під заголовком.',
                'promo-banner-heading' => 'Заголовок',
                'promo-banner-heading-block' => 'Заголовок',
                'promo-banner-text' => 'Текст',
                'save-btn' => 'Зберегти',
                'select' => 'Вибрати',
                'slider' => 'Слайдер',
        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'footer' => [
                        'title' => 'Вміст підвалу',
                        'info' => 'Налаштуйте слоган, номер телефону та адресу, що відображаються в підвалі магазину.',
                        'tagline' => 'Слоган',
                        'need-help-text' => 'Текст "Потрібна допомога"',
                        'phone-number' => 'Номер телефону',
                        'address-heading' => 'Заголовок адреси',
                        'address-trademark' => 'Рядок товарного знака',
                        'address-street' => 'Вулиця',
                        'address-city' => 'Місто / Поштовий індекс / Країна',
                        'address-vat' => 'ІПН / Реєстраційний номер',
                    ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'private-website' => [
                        'title' => 'Приватний сайт',
                        'title-info' => 'Якщо ввімкнено, кожна сторінка магазину вимагає, щоб відвідувач був авторизований як затверджений клієнт. Лише вхід, реєстрація та відновлення пароля залишаються доступними для гостей.',
                        'enabled' => 'Вимагати вхід для перегляду магазину',
                        'enabled-info' => 'Увімкніть це, коли магазин готовий до запуску і відвідувачі більше не повинні мати змогу переглядати його без реєстрації та затвердження.',
                    ],
                ],
            ],
