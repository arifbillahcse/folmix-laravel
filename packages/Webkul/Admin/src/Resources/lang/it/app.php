...
return [
        ...
        'orders' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'date' => 'Data',
                    'delete' => 'Elimina',
                    'delete-failed' => 'Impossibile eliminare l\'ordine.',
                    'delete-success' => 'Ordine eliminato con successo.',
                    'email' => 'Email',
                    'fraud' => 'Frode',
            ...
            'view' => [
                ...
                'contact' => 'Contatto',
                'delete' => 'Elimina',
                'delete-msg' => 'Sei sicuro di voler eliminare definitivamente questo ordine? Questa azione non può essere annullata e rimuoverà i suoi articoli, fatture, spedizioni e dati di pagamento.',
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Genere',
                    'group' => 'Gruppo',
                    'group-not-found' => 'Il gruppo clienti selezionato non è stato trovato.',
                    'id' => 'ID Cliente',
                    'id-value' => 'ID - :id',
                    'inactive' => 'Inattivo',
        ...
        'shipping-zones' => [
            'index' => [
                ...
                'form' => [
                    ...
                    'country' => 'Paese',
                    'country-multi-info' => 'È possibile selezionare più paesi.',
                    'free-shipping' => 'Spedizione Gratuita',
                    ...
                    'per-unit' => 'Per Unità',
                    'percent-of-cart' => 'Percentuale del Totale Carrello',
                    'percent-of-cart-info' => 'Addebita questa percentuale del subtotale del carrello, ma mai meno della Tariffa Minima - es. 6% con una tariffa minima di 12 addebita max(totale carrello x 6%, 12).',
                    'postcode' => 'CAP (opzionale)',
                    'postcode-multi-info' => 'Lasciare vuoto per includere tutto il paese, oppure inserire più CAP separati da virgole.',
                    'rate' => 'Tariffa',
                    'rate-percent' => 'Tariffa (%)',
                    'regions' => 'Regioni',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banner' => 'Banner Promozionale',
            ...
            'edit' => [
                ...
                'channels' => 'Canali',
                'column' => 'Colonna',
                'copy-to-all-locales-btn' => 'Copia in Tutte le Lingue',
                'copy-to-all-locales-confirm' => 'Questo sovrascriverà il contenuto salvato in tutte le altre lingue con quello attualmente salvato per questa lingua. Continuare?',
                'copy-to-all-locales-error' => 'Si è verificato un errore durante la copia in tutte le lingue.',
                'copy-to-all-locales-success' => 'Copiato in tutte le lingue con successo.',
                ...
                'promo-banner-add-card-btn' => 'Aggiungi Scheda',
                'promo-banner-button-text' => 'Testo del Pulsante',
                'promo-banner-card-image' => 'Immagine della Scheda',
                'promo-banner-card-title' => 'Titolo della Scheda',
                'promo-banner-cards' => 'Schede Promozionali',
                'promo-banner-cards-description' => 'Aggiungi, modifica, riordina o rimuovi le schede promozionali mostrate sotto il titolo.',
                'promo-banner-heading' => 'Titolo',
                'promo-banner-heading-block' => 'Titolo',
                'promo-banner-text' => 'Testo',
                'save-btn' => 'Salva',
                'select' => 'Seleziona',
                'slider' => 'Slider',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Offerto da :softorio.',
            ],
        ],
