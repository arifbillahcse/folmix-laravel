...
<x-shop::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('shop::app.home.suggested.title')
    </x-slot>

    <v-suggested-listing>
        <div class="container mt-20 max-lg:px-8 max-md:mt-8 max-sm:mt-7 max-sm:!px-4">
            <div class="folmix-suggested-product-grid">
    ...
    @pushOnce('scripts')
        <script
            ...
            id="v-suggested-listing-template"
        >
            <div class="container mt-20 max-lg:px-8 max-md:mt-8 max-sm:mt-7 max-sm:!px-4">
                ...
                <template v-else>
                    <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                        <p
                            ...
                            role="heading"
                        >
                            @lang('shop::app.home.suggested.empty')
                        </p>
                    </div>
                </template>
            </div>
        ...
        <script type="module">
            app.component('v-suggested-listing', {
                template: '#v-suggested-listing-template',
                ...
                methods: {
                    getProducts() {
                        this.$axios.get("{{ route('shop.api.products.suggested.index') }}")
                            .then(response => {
