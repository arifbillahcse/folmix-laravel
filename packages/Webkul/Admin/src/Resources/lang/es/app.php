...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Género',
                    'group' => 'Grupo',
                    'group-not-found' => 'No se encontró el grupo de clientes seleccionado.',
                    'id' => 'ID de Cliente',
                    'id-value' => 'ID - :id',
                    'inactive' => 'Inactivo',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    ...
                    'info' => 'Establece un precio personalizado para este cliente en productos específicos, anulando el precio de su grupo.',
                    'add-btn' => 'Añadir precio de producto',
                    'sku' => 'SKU - :sku',
                    'price' => 'Precio',
                    'regular-price' => 'Precio normal - :price',
                    'create-title' => 'Añadir precio especial',
                    'update-title' => 'Actualizar precio especial',
                    'save-btn' => 'Guardar',
                    'edit-btn' => 'Editar',
                    'delete-btn' => 'Eliminar',
                    'empty-title' => 'Sin precios especiales',
                    'empty-info' => 'Este cliente aún no tiene un precio personalizado en ningún producto.',
                    'create-success' => 'Precio especial añadido correctamente.',
                    'update-success' => 'Precio especial actualizado correctamente.',
                    'delete-success' => 'Precio especial eliminado correctamente.',
                ],
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Canales',
                'column' => 'Columna',
                'copy-to-all-locales-btn' => 'Copiar a Todos los Idiomas',
                'copy-to-all-locales-confirm' => 'Esto sobrescribirá el contenido guardado en todos los demás idiomas con el que está actualmente guardado para este idioma. ¿Continuar?',
                'copy-to-all-locales-error' => 'Algo salió mal al copiar a todos los idiomas.',
                'copy-to-all-locales-success' => 'Copiado a todos los idiomas correctamente.',
                ...
                'promo-banner-add-card-btn' => 'Añadir Tarjeta',
                'promo-banner-button-text' => 'Texto del Botón',
                'promo-banner-card-image' => 'Imagen de la Tarjeta',
                'promo-banner-card-title' => 'Título de la Tarjeta',
                'promo-banner-cards' => 'Tarjetas Promocionales',
                'promo-banner-cards-description' => 'Agrega, edita, reordena o elimina las tarjetas promocionales que se muestran debajo del encabezado.',
                'promo-banner-heading' => 'Encabezado',
                'promo-banner-heading-block' => 'Encabezado',
                'promo-banner-text' => 'Texto',
                'save-btn' => 'Guardar',
                'select' => 'Seleccionar',
                'slider' => 'Deslizador',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Desarrollado por :softorio.',
            ],
        ],
