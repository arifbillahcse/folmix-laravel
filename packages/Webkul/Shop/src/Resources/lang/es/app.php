...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Derechos de autor :current_year, Folmix. Todos los derechos reservados.',
        ...
        'signup-form' => [
            ...
            'vat-number' => 'NIF/IVA',
            'vat-number-hint' => 'Introduzca el número de IVA correcto',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'Perfil',
                        'search' => 'Buscar',
                        'search-no-results' => 'No se encontraron productos.',
                        'search-text' => 'Buscar productos aquí',
                        'search-view-all-prefix' => 'Ver todos los resultados de',
            ...
            'whatsapp' => [
                'chat-with-us' => 'Chatea con nosotros por WhatsApp',
            ],

            'footer' => [
                'about-tagline' => 'Bienvenido a Folmix. Explora nuestra amplia gama de piezas de repuesto y accesorios con la calidad y el servicio en los que puedes confiar.',
                'about-us' => 'Acerca de nosotros',
                'contact-us' => 'Contacto',
                'currency' => 'Moneda',
                'customer-service' => 'Servicio al cliente',
                'footer-content' => 'Contenido del pie de página',
                'footer-text' => '© Derechos de autor :current_year, Folmix. Todos los derechos reservados.',
                'locale' => 'Idioma',
                'need-help' => '¿Necesitas ayuda? ¡Llámanos!',
