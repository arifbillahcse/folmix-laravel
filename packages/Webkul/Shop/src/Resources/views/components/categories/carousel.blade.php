    ...
    >
        ...
        >
            <div class="relative">
                ...
                <span
                    class="icon-arrow-left-stylish absolute -left-10 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-black bg-white text-2xl transition hover:bg-black hover:text-white max-lg:-left-7 max-md:hidden"
                    style="top: 85px"
                    role="button"
                ...
                <span
                    class="icon-arrow-right-stylish absolute -right-6 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-black bg-white text-2xl transition hover:bg-black hover:text-white max-lg:-right-7 max-md:hidden"
                    style="top: 85px"
                    role="button"
