...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Genre',
                    'group' => 'Groupe',
                    'group-not-found' => 'Le groupe de clients sélectionné est introuvable.',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    ...
                    'sku' => 'SKU - :sku',
                    'price' => 'Prix',
                    'regular-price' => 'Prix normal - :price',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Canaux',
                'column' => 'Colonne',
                'copy-to-all-locales-btn' => 'Copier vers toutes les langues',
                'copy-to-all-locales-confirm' => 'Cela remplacera le contenu enregistré dans toutes les autres langues par celui actuellement enregistré pour cette langue. Continuer ?',
                'copy-to-all-locales-error' => 'Une erreur s\'est produite lors de la copie vers toutes les langues.',
                'copy-to-all-locales-success' => 'Copié avec succès vers toutes les langues.',
                ...
                'promo-banner-add-card-btn' => 'Ajouter une Carte',
                'promo-banner-button-text' => 'Texte du Bouton',
                'promo-banner-card-image' => 'Image de la Carte',
                'promo-banner-card-title' => 'Titre de la Carte',
                'promo-banner-cards' => 'Cartes Promotionnelles',
                'promo-banner-cards-description' => 'Ajoutez, modifiez, réorganisez ou supprimez les cartes promotionnelles affichées sous le titre.',
                'promo-banner-heading' => 'Titre',
                'promo-banner-heading-block' => 'Titre',
                'promo-banner-text' => 'Texte',
                'save-btn' => 'Enregistrer',
                'select' => 'Sélectionner',
                'slider' => 'Curseur',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Propulsé par :softorio.',
            ],
        ],
