...
@pushOnce('scripts')
    ...
    >
        ...
        <div
            ...
            class="absolute z-30 max-h-[70vh] w-full overflow-y-auto rounded-lg border border-zinc-200 bg-white shadow-[0px_10px_84px_rgba(0,0,0,0.1)] ltr:left-0 rtl:right-0 top-full"
        >
