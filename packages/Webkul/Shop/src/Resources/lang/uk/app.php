...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Копірайт :current_year, Folmix. Всі права захищені.',
        ...
        'login-form' => [
            ...
            'password' => 'Пароль',
            'please-login-first' => 'Будь ласка, увійдіть, щоб продовжити.',
        ...
        'signup-form' => [
            ...
            'vat-number-hint' => 'Будь ласка, введіть правильний номер ПДВ',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'Профіль',
                        'search' => 'Пошук',
                        'search-no-results' => 'Товари не знайдено.',
                        'search-text' => 'Шукати товари тут',
                        'search-view-all-prefix' => 'Переглянути всі результати для',
                        'sign-in' => 'Увійти',
            ...
            'search-suggestions' => [
                'no-results' => 'Товари не знайдено.',
                'searching' => 'Пошук...',
                'view-all-results-for' => 'Показати всі результати за запитом',
            ],
            ...
            'whatsapp' => [
                'chat-with-us' => 'Напишіть нам у WhatsApp',
            ],

            'footer' => [
                'about-tagline' => 'Ласкаво просимо до Folmix. Ознайомтеся з широким асортиментом запчастин та аксесуарів з якістю та сервісом, яким можна довіряти.',
                'about-us' => 'Про нас',
                'contact-us' => 'Зв\'язатися з нами',
                'currency' => 'Валюта',
                'customer-service' => 'Служба підтримки',
                'footer-content' => 'Вміст нижнього колонтитула',
                'footer-text' => '© Авторське право :current_year, Folmix. Усі права захищені.',
                'locale' => 'Мова',
                'need-help' => 'Потрібна допомога? Зателефонуйте нам!',
