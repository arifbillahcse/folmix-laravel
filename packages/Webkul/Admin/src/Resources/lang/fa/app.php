...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'جنسیت',
                    'group' => 'گروه',
                    'group-not-found' => 'گروه مشتری انتخاب‌شده یافت نشد.',
                    'id' => 'شناسه مشتری',
                    'id-value' => 'شناسه - :id',
                    'inactive' => 'غیرفعال',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    'title' => 'قیمت‌گذاری ویژه',
                    'info' => 'برای این مشتری روی محصولات خاص یک قیمت سفارشی تنظیم کنید که جایگزین قیمت گروه او می‌شود.',
                    ...
                    'edit-btn' => 'ویرایش',
                    'delete-btn' => 'حذف',
                    'empty-title' => 'بدون قیمت ویژه',
                    'empty-info' => 'این مشتری هنوز برای هیچ محصولی قیمت سفارشی ندارد.',
                    'create-success' => 'قیمت ویژه با موفقیت اضافه شد.',
                    'update-success' => 'قیمت ویژه با موفقیت به‌روزرسانی شد.',
                    'delete-success' => 'قیمت ویژه با موفقیت حذف شد.',
                ],
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'کانال‌ها',
                'column' => 'ستون',
                'copy-to-all-locales-btn' => 'کپی به همه زبان‌ها',
                'copy-to-all-locales-confirm' => 'این کار محتوای ذخیره‌شده در همه زبان‌های دیگر را با محتوای ذخیره‌شده فعلی برای این زبان جایگزین می‌کند. ادامه می‌دهید؟',
                'copy-to-all-locales-error' => 'هنگام کپی به همه زبان‌ها خطایی رخ داد.',
                'copy-to-all-locales-success' => 'با موفقیت به همه زبان‌ها کپی شد.',
                ...
                'promo-banner-add-card-btn' => 'افزودن کارت',
                'promo-banner-button-text' => 'متن دکمه',
                'promo-banner-card-image' => 'تصویر کارت',
                'promo-banner-card-title' => 'عنوان کارت',
                'promo-banner-cards' => 'کارت‌های تبلیغاتی',
                'promo-banner-cards-description' => 'کارت‌های تبلیغاتی نمایش داده شده زیر عنوان را اضافه، ویرایش، مرتب یا حذف کنید.',
                'promo-banner-heading' => 'عنوان',
                'promo-banner-heading-block' => 'عنوان',
                'promo-banner-text' => 'متن',
                'save-btn' => 'ذخیره',
                'select' => 'انتخاب',
                'slider' => 'اسلایدر',
        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'footer' => [
                        'title' => 'محتوای فوتر',
                        'info' => 'شعار، شماره تلفن و آدرسی که در فوتر فروشگاه نمایش داده می‌شود را پیکربندی کنید.',
                        'tagline' => 'شعار',
                        'need-help-text' => 'متن نیاز به کمک',
                        'phone-number' => 'شماره تلفن',
                        'address-heading' => 'عنوان آدرس',
                        'address-trademark' => 'خط علامت تجاری',
                        'address-street' => 'آدرس خیابان',
                        'address-city' => 'شهر / کد پستی / کشور',
                        'address-vat' => 'شماره مالیات بر ارزش افزوده / ثبت',
                    ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'private-website' => [
                        'title' => 'وب‌سایت خصوصی',
                        'title-info' => 'در صورت فعال بودن، هر صفحه از فروشگاه نیاز دارد که بازدیدکننده به‌عنوان مشتری تأییدشده وارد شده باشد. فقط ورود، ثبت‌نام و بازیابی رمز عبور برای مهمانان در دسترس می‌ماند.',
                        'enabled' => 'نیاز به ورود برای مرور فروشگاه',
                        'enabled-info' => 'زمانی که فروشگاه آماده راه‌اندازی است این گزینه را فعال کنید تا بازدیدکنندگان بدون ثبت‌نام و تأیید نتوانند مرور کنند.',
                    ],
                ],
            ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'قدرت گرفته از :softorio.',
            ],
        ],
