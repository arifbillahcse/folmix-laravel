...
return [
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Płeć',
                    'group' => 'Grupa',
                    'group-not-found' => 'Nie znaleziono wybranej grupy klientów.',
                    'id' => 'ID klienta',
                    'id-value' => 'Identyfikator - :id',
                    'inactive' => 'Nieaktywny',
            ...
            'view' => [
                ...
                'special-pricing' => [
                    ...
                    'sku' => 'SKU - :sku',
                    'price' => 'Cena',
                    'regular-price' => 'Cena regularna - :price',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Kanały',
                'column' => 'Kolumna',
                'copy-to-all-locales-btn' => 'Kopiuj do wszystkich języków',
                'copy-to-all-locales-confirm' => 'Spowoduje to nadpisanie zapisanej zawartości we wszystkich innych językach zawartością aktualnie zapisaną dla tego języka. Kontynuować?',
                'copy-to-all-locales-error' => 'Coś poszło nie tak podczas kopiowania do wszystkich języków.',
                'copy-to-all-locales-success' => 'Pomyślnie skopiowano do wszystkich języków.',
                ...
                'promo-banner-add-card-btn' => 'Dodaj Kartę',
                'promo-banner-button-text' => 'Tekst Przycisku',
                'promo-banner-card-image' => 'Obraz Karty',
                'promo-banner-card-title' => 'Tytuł Karty',
                'promo-banner-cards' => 'Karty Promocyjne',
                'promo-banner-cards-description' => 'Dodawaj, edytuj, zmieniaj kolejność lub usuwaj karty promocyjne wyświetlane pod nagłówkiem.',
                'promo-banner-heading' => 'Nagłówek',
                'promo-banner-heading-block' => 'Nagłówek',
                'promo-banner-text' => 'Tekst',
                'save-btn' => 'Zapisz',
                'select' => 'Wybierz',
                'slider' => 'Suwak',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Obsługiwane przez :softorio.',
            ],
        ],
