...
return [
        ...
        'orders' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'date' => 'Date',
                    'delete' => 'Delete',
                    'delete-failed' => 'Failed to delete the order.',
            ...
            'view' => [
                ...
                'delete' => 'Delete',
                'delete-msg' => 'Are you sure you want to permanently delete this order? This cannot be undone and will remove its items, invoices, shipments, and payment records.',
                'comments' => 'Comments',
                'completed' => 'Completed',
                'contact' => 'Contact',
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Gender',
                    'group' => 'Group',
                    'group-not-found' => 'The selected customer group could not be found.',
                    'id' => 'Customer ID',
                    'id-value' => 'ID - :id',
                    'inactive' => 'Inactive',
                    'method-error' => 'Error! Wrong method detected, please check mass action configuration',
    ...
    'settings' => [
        ...
        'shipping-zones' => [
            'index' => [
                ...
                'form' => [
                    ...
                    'country' => 'Country',
                    'country-multi-info' => 'You can select multiple countries.',
                    'free-shipping' => 'Free Shipping',
                    'flat-rate' => 'Flat Rate',
                    ...
                    'per-order' => 'Per Order',
                    'per-unit' => 'Per Unit',
                    'percent-of-cart' => 'Percentage of Cart Total',
                    'percent-of-cart-info' => 'Charges this percentage of the cart subtotal, but never less than the Minimum Fee - e.g. 6% with a minimum fee of 12 charges max(cart total x 6%, 12).',
                    'postcode' => 'Postcode (optional)',
                    'postcode-multi-info' => 'Leave empty to match the whole country, or enter several postcodes separated by commas.',
                    'rate' => 'Rate',
                    'rate-percent' => 'Rate (%)',
                    'regions' => 'Regions',
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Channels',
                'column' => 'Column',
                'copy-to-all-locales-btn' => 'Copy To All Languages',
                'copy-to-all-locales-confirm' => 'This will overwrite the saved content in every other language with what is currently saved for this language. Continue?',
                'copy-to-all-locales-error' => 'Something went wrong while copying to all languages.',
                'copy-to-all-locales-success' => 'Copied to all languages successfully.',
                ...
                'promo-banner-add-card-btn' => 'Add Card',
                'promo-banner-button-text' => 'Button Text',
                'promo-banner-card-image' => 'Card Image',
                'promo-banner-card-title' => 'Card Title',
                'promo-banner-cards' => 'Promo Cards',
                'promo-banner-cards-description' => 'Add, edit, reorder or remove the promo cards shown below the heading.',
                'promo-banner-heading' => 'Heading',
                'promo-banner-heading-block' => 'Heading',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Powered by :softorio.',
            ],
        ],
