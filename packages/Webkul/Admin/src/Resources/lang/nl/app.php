        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'gender' => 'Geslacht',
                    'group' => 'Groep',
                    'group-not-found' => 'De geselecteerde klantgroep kon niet worden gevonden.',
                    'id' => 'Klant ID',
                    'id-value' => 'ID - :id',
                    'inactive' => 'Inactief',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'channels' => 'Kanalen',
                'column' => 'Kolom',
                'copy-to-all-locales-btn' => 'Kopiëren naar alle talen',
                'copy-to-all-locales-confirm' => 'Dit overschrijft de opgeslagen inhoud in alle andere talen met de inhoud die momenteel voor deze taal is opgeslagen. Doorgaan?',
                'copy-to-all-locales-error' => 'Er is iets misgegaan bij het kopiëren naar alle talen.',
                'copy-to-all-locales-success' => 'Succesvol gekopieerd naar alle talen.',
                ...
                'promo-banner-add-card-btn' => 'Kaart Toevoegen',
                'promo-banner-button-text' => 'Knoptekst',
                'promo-banner-card-image' => 'Kaartafbeelding',
                'promo-banner-card-title' => 'Kaarttitel',
                'promo-banner-cards' => 'Promokaarten',
                'promo-banner-cards-description' => 'Voeg de promokaarten onder de titel toe, bewerk, herschik of verwijder ze.',
                'promo-banner-heading' => 'Titel',
                'promo-banner-heading-block' => 'Titel',
