                ...
                <div class="p-6 space-y-4 max-md:p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-4">
                        ...
                        <a 
                            ...
                            class="text-navyBlue hover:underline" target="_blank"
                        >
                            #{{ $rma->order_id }}
                        </a>
                    </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                @if ($item->orderItem->product?->url_key && $item->orderItem->product?->visible_individually)
                                    <a
                                        href="{{ route('shop.product_or_category.index', $item->orderItem->product->url_key) }}"
                                        class="text-navyBlue hover:underline text-sm font-medium"
                                        target="_blank"
                                    >
                                        {{ $item->orderItem->name }}
                                    </a>
                        ...
                        >
                            ...
                            <div class="flex justify-end">
                                <button class="primary-button text-sm max-sm:text-xs max-sm:px-4 max-sm:py-2" :disabled="!isChatSend">
                                    <svg v-if="!isChatSend" aria-hidden="true" class="w-5 h-5 max-sm:w-4 max-sm:h-4 text-gray-200 animate-spin fill-navyBlue" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            app.component('rma-status-and-conversation', {
                ...
                methods: {
                    ...
                    handleFileSelect($event) {
                        ...
                        removeButton.classList.add('removeFile', 'text-navyBlue');
